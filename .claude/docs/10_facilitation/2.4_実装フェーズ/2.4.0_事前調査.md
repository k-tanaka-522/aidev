...
実装フェーズ開始前に、**Notion技術標準を最優先で参照**し、最新のライブラリ・ベストプラクティスを調査することで、高品質なコード生成を実現する。
...
実装フェーズでは、**コード生成前に必ずNotion技術標準を参照**する。
...
**「Notion技術標準を基盤に、最新ベストプラクティスを組み合わせる」**
