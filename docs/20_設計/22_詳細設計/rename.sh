...
echo "ファイル移動が完了しました。"
echo "新しいファイル構造を確認してください。問題なければ、古いディレクトリとファイルを削除できます。"
echo "確認後、以下のコマンドで削除できます："
echo "rm -rf /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/01_*"
echo "rm -rf /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/02_*"
echo "rm -rf /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/03_*"
echo "rm -rf /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/04_*"
echo "rm -rf /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/05_*"
echo "rm -rf /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/06_*"
echo "rm -f /mnt/c/dev2/aiDev/docs/20_設計/22_詳細設計/07_*"
